"""
Helper del Procesador Sísmico: funciones orquestadoras y utilitarias.
Contiene las funciones que estaban en procesador_sismico_limpio.py
"""
...
from config import (
    ...
    PRECISION_DECIMAL, mostrar_configuracion
)
